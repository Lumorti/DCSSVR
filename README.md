...
[example.webm](https://github.com/user-attachments/assets/766cd181-cce0-46a7-be1d-6dbc16a1168c)
...
There's also an experimental APK for Quest, but this requires you to run a server (i.e. "server.exe") on a device on the same network. This hasn't been tested as much as the desktop VR version, and the server can be somewhat unreliable. The server is needed since Quest doesn't allow running Crawl as a subprocess like on Windows.
